...
public class GUI implements MouseListener {
    ...
    // constructor conain all gui component to only by creaing object of the class
    // run all things
    public GUI() {
        // frame part
        frame = new JFrame();
    ...
    public static void main(String[] args) {
        // this line comes from Gemini AI to because there is a lot of logic that slow
        // down the gui loading so this line solved this problem
