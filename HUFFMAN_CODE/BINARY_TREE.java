...
public class BINARY_TREE {
    ...
    public String TraversTree(NodeTree node, String encode, char letter) {
        ...
        String left;
        String right;
        // base case if we reach a leaf node because all nodes that have the characters
        // are leaf nodes
        ...
        // if not reach a leaf node
            ...
            // search left side and add 0 for each search of left side and store the value
            // in a left string
            ...
            // if left is null then search right
                ...
                // search right side and add 1 for each search of right side and store the value
                // in a right string
        ...
        // if none of them happend then we don't have this character in the tree so
        // return null
        return null;
    }
}
...
class NodeTree {
    ...
    // a constructor for normal nodes that inialize frequency and character of each
    // node
    ...
    // a constructor that used in mixing tree when sum frequency added but not nead
    // any character for new root
